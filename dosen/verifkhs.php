...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4" style="width: 80%;">
            <h3 class="mt-4 mb-4">Verifikasi Berkas -> KHS</h3>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table dataTable" id="datatablesSimple1">
                        ...
                        <tbody>
                        <?php
                                $query = "SELECT mahasiswa.NIM,mahasiswa.Nama FROM mahasiswa,khs WHERE mahasiswa.NIM = khs.NIM AND khs.status='Belum' AND mahasiswa.NIP_Doswal = '$nip_dosen'";
                                ...
                                while ($row = $result->fetch_object()) {
                                    ...
                                    <td>".$row->NIM."</td>
                                    <td>".$row->Nama."</td>
                                    <td><a class='btn btn-primary' href='lihatkhs.php?id=".$row->NIM."'>Lihat</a></td>";
                                    $i++;                        
                                }
                            ?>
                        </tbody>
