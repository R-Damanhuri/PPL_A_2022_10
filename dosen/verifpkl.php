            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table class="table dataTable" id="datatablesSimple1">
                        ...
                        <tbody>
                        <?php
                                $query = "SELECT mahasiswa.NIM,mahasiswa.Nama FROM mahasiswa,pkl WHERE mahasiswa.NIM = pkl.NIM AND pkl.status_verif ='Belum' AND mahasiswa.NIP_Doswal = '$nip_dosen' AND pkl.status != 'Belum Aktif'";
                                ...
                                while ($row = $result->fetch_object()) {
                                    ...
                                    <td>".$row->NIM."</td>
                                    <td>".$row->Nama."</td>
                                    <td><a class='btn btn-primary' href='lihatpkl.php?id=".$row->NIM."'>Lihat</a></td>";
                                    $i++;                        
                                }
                            ?>
                        </tbody>
