...
// }
    ...
    function view_data(updateid){
        ...
        $.ajax({
            ...
            success:function(data){
                let mhs = JSON.parse(data);
                let hp = mhs.No_Hp.split(" ").join("");
                $('#upnamamhs').val(mhs.Nama);
                $('#upemailmhs').val(mhs.Email);
                $('#upnohpmhs').val(hp);
                console.log(mhs);
                console.log(hp);
            }
    ...
    $("#modalupmhs").validate({
        ...
        messages: {
            upnamamhs: "Masukan inputan nama",
            upemailmhs: "Masukan email pribadi",
            upnohpmhs: "Masukan no handphone aktif"
        },
        submitHandler: function(){
            let upnamamhs = $('#upnamamhs').val();
            let upemailmhs = $('#upemailmhs').val();
            // let upstat = $('#upstat').attr('selected', 'selected').val();
            // let upstat = $('#upstat').on('change',function(){
                // console.log(('#upstat option:selected').val())
            let upnohpmhs = $('#upnohpmhs').val(); 
            let upid = $('#hiddenuid').val();
