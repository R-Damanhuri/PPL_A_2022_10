...
<div id="layoutSidenav_content">
    <div class="container-fluid px-4" style="width: 40%">
        <h3 class="my-3" style="text-align: center">IRS Mahasiswa</h3>
        <main>
            <div class="card">
                    ...
                    <form class="form-irs" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input id="sks" name="sks" type="number" aria-describedby="HelpBlock" class="form-control">
                            </div>
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Jumlah Maksimum sks yang diambil semester ini <?php echo $sksmax ?> </span>
                            <div class="error" style="color:red"><?php if (isset($error_sks)) echo $error_sks ?></div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Semester Aktif</label>
                            <div class="input-group">
                                <input id="semester" name="semester" type="number" aria-describedby="HelpBlock" class="form-control">
                            </div>
