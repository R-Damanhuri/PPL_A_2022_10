...
<div id="layoutSidenav_content">
    <div class="container-fluid px-4" style="width: 40%">
        <h3 class="my-3" style="text-align: center">KHS Mahasiswa</h3>
        <main>
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-irs" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Semester yang ditempuh TP 2022/ 2023 </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> SKS semester terakhir</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Total SKS yang diambil</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> IP semester terakhir</span>
