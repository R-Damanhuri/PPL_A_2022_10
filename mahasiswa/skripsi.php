...
if (isset($_POST["submit"])){
        ...
        if (!$_FILES['berkas_skripsi']['error']>0){
            ...
            $folder = "../assets/skripsi/" . $final_pdf;
            $allowed = array('pdf');
        ...
        if ($valid){
            ...
            $query = "UPDATE skripsi SET Status='$status',Nilai='$nilai',Berkas_Skripsi='$folder',Lama_Studi_tahun=$lama_studi, Tanggal_Sidang='$tanggal_sidang' WHERE nim = '$nim' "; 
            // Execute the query
                ...
                <div class="card-body">
                    <form class="form-irs" method="post" enctype="multipart/form-data">
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Lulus, Sedang Menempuh, Belum Lulus, Belum Aktif</span>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Nilai Skripsi</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Tahun</span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <span id="HelpBlock" class="form-text text-muted"><i class="fa fa-info-circle" aria-hidden="true"></i> Format </span>
                            <div class="error"><?php if (isset($error_tanggal_sidang)) echo $error_tanggal_sidang ?></div>
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Berkas Sidang Skripsi</label>
                            <div class="input-group">
